...
FilePath: /code/hil-serl/examples/experiments/hirol_pick_place/wrapper.py
'''
"""HIROL Pick Place Environment Wrapper"""
...
class HIROLPickPlaceEnv(HIROLEnv):
    """
    HIROL Pick Place task environment.
    
    This environment is specifically designed for pick and place tasks using
    HIROLRobotPlatform. It includes object grasping, lifting, transporting,
